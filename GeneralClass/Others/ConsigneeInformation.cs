...
public string What3Words = "";
        ...
        internal void CheckConsigneeData(ClientInformation ClientInfo, ConsigneeInformation _consignee, bool? IsCourierLoadType = false)
        {
           ...
           // CInstance.ConsigneeBirthDate = _consignee.ConsigneeBirthDate;
            ...
            CDInstance.SPLOfficeID = string.IsNullOrWhiteSpace(_consignee.SPLOfficeID) ? "" : _consignee.SPLOfficeID;
            ...
            var ParcelLockerMachineID_int = int.TryParse(ParcelLockerMachineID, out int outParcelLockerMachineID_int);
            CDInstance.MachineID = CDInstance.MachineID = string.IsNullOrWhiteSpace(_consignee.ParcelLockerMachineID) || ParcelLockerMachineID_int == false ? 0 : outParcelLockerMachineID_int;
