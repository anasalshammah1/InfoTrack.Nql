    ...
    public class XMLHHD : System.Web.Services.WebService
    {
        ...
        public bool CheckConnectionToServerDB(byte[] EmpID)
        {
            ...
            try
            {
                ...
                catch (Exception x) { GlobalVar.GV.InsertError("1 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("2 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return result;
        }
        ...
        private bool CheckConnectionToServerDB()
        {
            ...
            try
            {
                ...
                catch (Exception x) { GlobalVar.GV.InsertError("3 - " + x.Message,"0"); }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("4 - " + x.Message, "0"); }
            return result;
        }
        ...
        {
            //GlobalVar.GV.InsertError("test", "34343");
        }
        ...
        public bool SendPickUpDataToServer(InfoTrackSEData ds, byte[] EmpID)
        {
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    //GlobalVar.GV.InsertError(" Pickup count : " + ds.PickUp.Rows.Count.ToString(), GlobalVar.GV.IsSecure(EmpID).ToString());
                    ...
                    catch (Exception ww)
                    {
                        ...
                        result = false;
                        c.Close();
                        GlobalVar.GV.InsertError("5 - " + ww.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("6 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return result;
        }
        ...
        public bool SendBookingWaybillDataToServer(InfoTrackSEData ds, byte[] EmpID)
        {
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    {
                        GlobalVar.GV.InsertError("An Error", GlobalVar.GV.GetEmpID(EmpID).ToString());
                        T.Rollback();
                        result = false;
                        c.Close();
                        GlobalVar.GV.InsertError("5 - " + ww.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        c.Close();
                        result = false;
                        GlobalVar.GV.InsertError("50 - " + xx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("7 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return result;
        }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        c.Close();
                        result = false;
                        GlobalVar.GV.InsertError("501 - " + xx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("7 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        result = false;
                        c.Close();
                        GlobalVar.GV.InsertError("51 - " + xx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("8 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return result;
        }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        result = false;
                        c.Close();
                        GlobalVar.GV.InsertError("52 - " + xx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("9 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return result;
        }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    for (int i = 0; i < ds.UserMeLogin.Rows.Count; i++)
                        ...
                        catch (Exception mc) { GlobalVar.GV.InsertError(mc.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
                    try
                    {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        result = false;
                        c.Close();
                        GlobalVar.GV.InsertError("520 - " + xx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("9 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        result = false;
                        c.Close();
                        GlobalVar.GV.InsertError("SendBorderCheckingDataToServer1 - " + xx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("SendBorderCheckingDataToServer 2 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return result;
        }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        c.Close();
                        result = false;
                        GlobalVar.GV.InsertError("53 - " + xx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("10 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return result;
        }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        result = false;
                        c.Close();
                        GlobalVar.GV.InsertError("520 -Visual Factor " + xx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("9 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        c.Close();
                        result = false;
                        GlobalVar.GV.InsertError("45 - " + xx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("11 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return result;
        }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception exx)
                    {
                        ...
                        c.Close();
                        result = false;
                        GlobalVar.GV.InsertError("100 - " + exx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("12 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return result;
        }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        result = false;
                        c.Close();
                        GlobalVar.GV.InsertError("55 - " + xx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("13 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return result;
        }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        result = false;
                        c.Close();
                        GlobalVar.GV.InsertError("255 - " + xx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("130 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return result;
        }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        result = false;
                        c.Close();
                        GlobalVar.GV.InsertError("56 - " + xx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("14 -" + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return result;
        }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        c.Close();
                        result = false;
                        GlobalVar.GV.InsertError("57 - " + xx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("15 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return result;
        }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        result = false;
                        c.Close();
                        GlobalVar.GV.InsertError("58 - " + xx.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("16 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return result;
        }
        ...
        [WebMethod]
        public bool SendStorageLocationToServer(InfoTrackSEData ds, byte[] EmpID)
        {
            bool result = false;
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    App_Data.InfoTrackSEDataTableAdapters.StorageLocationTableAdapter adapter = new StorageLocationTableAdapter();
                    adapter.Connection.ConnectionString = GlobalVar.GV.GetInfoTrackSEConnection();
                    ...
                    for (int i = 0; i < ds.StorageLocation.Rows.Count; i++)
                        (ds.StorageLocation.Rows[i] as InfoTrackSEData.StorageLocationRow).SetAdded();

                    try
                    {
                        adapter.Update(ds.StorageLocation);
                        T.Commit();
                        c.Close();
                        result = true;
                    }
        ...
        [WebMethod]
        public bool SendWaybillMeasurementDataToServer(InfoTrackSEData ds, byte[] EmpID)
        {
            bool result = false;
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    WaybillMeasurementTableAdapter adapterH = new WaybillMeasurementTableAdapter();
                    WaybillMeasurementDetailTableAdapter adapterD = new WaybillMeasurementDetailTableAdapter();
                    ...
                    for (int i = 0; i < ds.WaybillMeasurement.Rows.Count; i++)
                    {
                        InfoTrackSEData.WaybillMeasurementRow CRow = ds.WaybillMeasurement.Rows[i] as InfoTrackSEData.WaybillMeasurementRow;
                        CRow.SetAdded();
                        //if (CRow.IsCurrentVersionNull())
                        //    CRow.CurrentVersion = "";
                    }

                    for (int i = 0; i < ds.WaybillMeasurementDetail.Rows.Count; i++)
                        (ds.WaybillMeasurementDetail.Rows[i] as InfoTrackSEData.WaybillMeasurementDetailRow).SetAdded();

                    try
                    {
                        adapterH.Update(ds.WaybillMeasurement);

                        int ID = 0;
                        for (int i = 0; i < ds.WaybillMeasurement.Rows.Count; i++)
                        {
                            ID = 0;
                            InfoTrackSEData.WaybillMeasurementRow row = (ds.WaybillMeasurement.Rows[i] as InfoTrackSEData.WaybillMeasurementRow);
                            ID = Convert.ToInt32(adapterH.GetMaxID(row.WaybillNo, row.TotalPieces, row.EmployID));

                            for (int j = 0; j < ds.WaybillMeasurementDetail.Rows.Count; j++)
                            {
                                if ((ds.WaybillMeasurementDetail.Rows[j] as InfoTrackSEData.WaybillMeasurementDetailRow).WaybillMeasurementID == row.ID)
                                    (ds.WaybillMeasurementDetail.Rows[j] as InfoTrackSEData.WaybillMeasurementDetailRow).WaybillMeasurementID = ID;
                            }
                        }

                        adapterD.Update(ds.WaybillMeasurementDetail);
                        T.Commit();
                        c.Close();
                        result = true;
                    }
                    catch (Exception ww)
                    {
                        ...
                        result = false;
                        c.Close();
                        GlobalVar.GV.InsertError("599 - " + ww.Message, GlobalVar.GV.GetEmpID(EmpID).ToString());
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("6 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
        ...
        public InfoTrackData.StationDataTable BringStationFromServer(byte[] EmpID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("17" + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return table;
        }
        ...
        public InfoTrackData.RouteDataTable BringRouteFromServer(byte[] EmpID, int StationID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("18" + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return table;
        }

        [WebMethod]
        public InfoTrackData.NoNeedVolumeReasonDataTable BringNoNeedVolumeReasonFromServer(byte[] EmpID)
        {
            NaqelAPI.App_Data.InfoTrackDataTableAdapters.NoNeedVolumeReasonTableAdapter Adapter = new App_Data.InfoTrackDataTableAdapters.NoNeedVolumeReasonTableAdapter();
            Adapter.Connection.ConnectionString = GlobalVar.GV.GetInfoTrackConnection();
            InfoTrackData.NoNeedVolumeReasonDataTable table = new InfoTrackData.NoNeedVolumeReasonDataTable();
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("1000" + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return table;
        }
        ...
        public InfoTrackData.BorderClearenceDataTable BringBordersFromServer(byte[] EmpID, int StationID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("BringBordersFromServer - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return table;
        }
        ...
        public InfoTrackData.ViwTmpPiecesListFDSDataTable BringViwTmpPiecesListFDSByStation(byte[] EmpID, int StationID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("19 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return table;
        }
        ...
        public InfoTrackData.HHViwDeliverySheetDataTable BringHHViwDeliverySheet(byte[] EmpID, int DeliverySheetID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("20 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return table;
        }
        ...
        public InfoTrackData.ViwTmpPiecesListFDSDataTable BringViwTmpPiecesListFDSByRoute(byte[] EmpID, int StationID, int RouteID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("21 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return table;
        }
        ...
        public InfoTrackData.ViwTmpPiecesListFTPDataTable BringViwTmpPiecesListFTBByDays(byte[] EmpID, int StationID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("22 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return table;
        }
        ...
        public InfoTrackData.DeliveryStatusDataTable BringDeliveryStatusFromServer(byte[] EmpID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("23 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return table;
        }
        ...
        public InfoTrackData.ViwMEWaybillDataTable BringWaybillFromServer(System.Collections.Generic.List<int> waybillList, byte[] EmpID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("24 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return table;
        }
        ...
        public InfoTrackData BringEmpRoleFromServer(List<int> EmployID, byte[] EmpID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("25 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return dstmp;
        }
        ...
        public InfoTrackData BringTripCodeFormServer(byte[] EmpID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("26" + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return ds;
        }
        ...
        public byte[] GetUserPassword(int EmployID, byte[] EmpID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("27" + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return userpassword;
        }
        ...
        public bool ChangeUserPassword(int EmployID, byte[] NewPassword, byte[] EmpID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("28" + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return true;
        }
        ...
        public int GetTripCodeDetailID(byte[] EmpID, int SystemTripPlanID, int StationID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("29" + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
        ...
        [WebMethod]
        public List<StorageLocation> GetStorageLocationByWaybillNo(byte[] EmpID, int WaybillNo)
        {
            List<StorageLocation> ResultList = new List<StorageLocation>();
            if (!GlobalVar.GV.IsSecure(EmpID)) return ResultList;

            App_Data.InfoTrackData ds = new InfoTrackData();
            App_Data.InfoTrackDataTableAdapters.ViwStorageLocationTableAdapter adapter = new App_Data.InfoTrackDataTableAdapters.ViwStorageLocationTableAdapter();
            adapter.Connection = new SqlConnection(GlobalVar.GV.GetInfoTrackConnection());
            adapter.FillByWaybillNo(ds.ViwStorageLocation, WaybillNo);

            //for (int i = 0; i < ds.ViwStorageLocation.Count; i++)
            //    ResultList.Add((ds.ViwStorageLocation[i] as App_Data.InfoTrackData.ViwStorageLocationRow));

            StorageLocation instance = new StorageLocation();
            for (int i = ds.ViwStorageLocation.Count; i > 0; i--)
            {
                instance.BinID = (ds.ViwStorageLocation[i - 1] as App_Data.InfoTrackData.ViwStorageLocationRow).BinID;
                instance.BinCode = (ds.ViwStorageLocation[i - 1] as App_Data.InfoTrackData.ViwStorageLocationRow).BinCode;
                instance.Date = (ds.ViwStorageLocation[i - 1] as App_Data.InfoTrackData.ViwStorageLocationRow).Date;
                instance.EmployID = (ds.ViwStorageLocation[i - 1] as App_Data.InfoTrackData.ViwStorageLocationRow).EmployID;
                instance.RackCode = (ds.ViwStorageLocation[i - 1] as App_Data.InfoTrackData.ViwStorageLocationRow).RackCode;
                instance.AreaCode = (ds.ViwStorageLocation[i - 1] as App_Data.InfoTrackData.ViwStorageLocationRow).AreaCode;
                instance.TerminalCode = (ds.ViwStorageLocation[i - 1] as App_Data.InfoTrackData.ViwStorageLocationRow).TerminalCode;
                instance.CityCode = (ds.ViwStorageLocation[i - 1] as App_Data.InfoTrackData.ViwStorageLocationRow).CityCode;
            ...
            List<App_Data.rpDeliverySheet> listDeliverySheet = dcData.rpDeliverySheets.Where(P => P.WayBillNo == WaybillNo).OrderByDescending(P => P.Date).ToList();
            if (listDeliverySheet.Count() > 0)
            {
                instance.DeliverySheetID = listDeliverySheet.First().ID;
                instance.DeliverySheetDate = listDeliverySheet.First().Date;
                instance.CourierID = listDeliverySheet.First().CourierID.Value;
                instance.CourierName = listDeliverySheet.First().CourierName;
            }
        ...
        public bool IsClientCorrect(int ClientID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("30" + x.Message, "0"); }
            return result;
        }
        ...
        public bool IsCourierCorrrect(int CourierID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("31" + x.Message, "0"); }
            return result;
        }
        ...
        public bool IsWaybillExist(string WaybillNo)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("32" + x.Message, "0"); }
            return result;
        }
        ...
        public bool IsTripCorrrect(int TripID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("33" + x.Message,"0"); }
            return result;
        }
        ...
        public bool IsTripCorrrects(int TripID, int EmployID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("33" + x.Message, EmployID.ToString()); }
            return result;
        }
            ...
            try
            {
                ...
                try
                {
                    if (!System.IO.File.Exists(GlobalVar.GV.PicPath + ImageName))
                    {
                        ...
                        catch (Exception j) { GlobalVar.GV.InsertError(j.Message.ToString(), "0"); }
                    }
                    else
        ...
        public bool RestPassword(byte[] EmpID, int EmployID, byte[] NewPasswrod, int ITEmployID, string MachineID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("*Leave it 34 - " + x.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            return false;
        }
            ...
            try
            {
                ...
                if (CheckConnectionToServerDB())
                {
                    ...
                    catch (Exception xx)
                    {
                        ...
                        c.Close();
                        result = false;
                        GlobalVar.GV.InsertError("53 - " + xx.Message, "0");
                    }
                }
            }
            catch (Exception x) { GlobalVar.GV.InsertError("10 -TripStatus " + x.Message, "0"); }
            return result;
        }
        ...
        public InfoTrackData.ViewTripStatusDataTable GetTripDataFromServer(int EmployID)
        {
            ...
            catch (Exception x) { GlobalVar.GV.InsertError("24 - " + x.Message, EmployID.ToString()); }
            return table;
        ...
        public string UploadFile(byte[] fs, string fileName, bool CreateDirectory, string OldFileName)
        {
            ...
            catch (Exception ex) { GlobalVar.GV.InsertError(ex.Message,"0"); }
        ...
        class TransferFile
        {
            ...
            ///// <summary>
            ///// ConvertStreamToByteBuffer1：Convert Stream To ByteBuffer。
            ///// </summary>
        ...
        public InfoTrackData GetNewMessage(byte[] EmpID, int EmployID, int StationID)
        {
            ...
            catch (Exception ee) { GlobalVar.GV.InsertError(" 999 " + ee.Message, GlobalVar.GV.GetEmpID(EmpID).ToString()); }
            ...
            //GlobalVar.GV.InsertError("Messages Count " + dt.HHDMessage.Rows.Count.ToString(), GlobalVar.GV.GetEmpID(EmpID).ToString());
            return dt;
        }
        ...
        public InfoTrack.NaqelAPI.ShipmentDetails GetShipmentDetails(byte[] EmpID, int WaybillNo)
        {
            ...
            DataDataContext dcData = new DataDataContext();
            dcData.Connection.ConnectionString = GlobalVar.GV.GetInfoTrackConnection();

            if (dcData.ViwWaybills.Where(P => P.WayBillNo == WaybillNo && P.IsCancelled == false).Count() > 0)
            {
                ViwWaybill instance = dcData.ViwWaybills.First(P => P.WayBillNo == WaybillNo && P.IsCancelled == false);
                ...
                {
                    CustomerWayBill instance = dcData.CustomerWayBills.First(P => P.WayBillNo == WaybillNo && P.StatusID == 1);
                    Result.ClientID = instance.ClientID;
                    Result.OrgID = instance.OriginStationID;
                    Result.DestID = instance.DestinationStationID;
                    Result.Weight = instance.Weight;
